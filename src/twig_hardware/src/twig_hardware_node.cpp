...
const std::string PARAM_HW_CONFIG_MAX_CURRENT_COOLDOWN_DURATION = "hardware_config.max_current_cooldown_duration";
...
public:
        ...
        : Node(NODE_NAME, options)
    {
        ...
        // Activation Status Publishers
        shoulder_servo_activation_status_pub_ = create_bool_publisher("shoulder/servo/status/activation");
